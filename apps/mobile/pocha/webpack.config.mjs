...
export default env => {
  ...
  return {
    ...
    plugins: [
      ...
      // Here, we set up module federation for pocha app
      // letting host app know about it
      new Repack.plugins.ModuleFederationPlugin({
        ...
        shared: {
          react: {
            ...
            // [NOTE] only host app should be eager
            // But to run the host app standalone, we need to set it to true
            eager: STANDALONE,
          },
          'react-native': {
